...
<head>
     ...
     <link rel=stylesheet type='text/css' href='stylesheets/bioStyleSheet.css'>
...
<div class='container-fluid'>
     <div>
          <img id='bgImage' name='backgroundImage' src='images/indexBack2.png'>
     </div>
     <div class='row'>
          <div class='col-xs-10 col-sm-10 col-md-12 col-lg-12'>
               <?php include 'bioNavBar.php'; ?>
          </div>
     </div>
     <div class='footer'>
          <div class='row'>
